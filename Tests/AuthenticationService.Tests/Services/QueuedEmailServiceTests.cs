...
public class QueuedEmailServiceTests
{
    ...
    {
        // SendEmailAsync just enqueues — SMTP dispatch is out of band.
    ...
    {
        // Channel is SingleWriter=false; BoundedCapacity=1000 so 50 fits comfortably.
        var service = BuildService();
    ...
    {
        // Producer catches the QueueWriteTimeout OperationCanceledException and drops the message —
