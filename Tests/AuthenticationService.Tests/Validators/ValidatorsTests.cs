...
public class ValidatorsTests
{
    ...
    [Fact]
    public void DataProtectionSettingsValidator_NamedInstance_SkipsValidation()
    {
        // arrange
        var validator = new DataProtectionSettingsValidator(StubEnvironment("Production"));
    ...
    [Fact]
    public void DataProtectionSettingsValidator_Development_AllowsMissingCert()
    {
        // arrange — `dotnet run` first-time must not require a PFX file on disk.
        var validator = new DataProtectionSettingsValidator(StubEnvironment("Development"));
        var settings = new DataProtectionSettings();
    ...
    [Fact]
    public void DataProtectionSettingsValidator_NonDevelopmentCertMissing_FailsWithExplicitMessage()
    {
    ...
    [InlineData("")]
    [InlineData("   ")]
    public void DataProtectionSettingsValidator_NonDevelopmentPfxPathBlank_Fails(string? pfxPath)
    {
    ...
    [Fact]
    public void DataProtectionSettingsValidator_NonDevelopmentPfxPathPopulated_Succeeds()
    {
    ...
    [InlineData("Production")]
    [InlineData("custom-env-name")]
    public void DataProtectionSettingsValidator_AnyNonDevelopmentEnv_RequiresCert(string envName)
    {
        // arrange
        var validator = new DataProtectionSettingsValidator(StubEnvironment(envName));
        var settings = new DataProtectionSettings();
