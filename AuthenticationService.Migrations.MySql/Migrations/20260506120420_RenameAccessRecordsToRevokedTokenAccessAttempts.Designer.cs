...
namespace AuthenticationService.Migrations.MySql.Migrations
{
    ...
    [Migration("20260506120420_RenameAccessRecordsToRevokedTokenAccessAttempts")]
    partial class RenameAccessRecordsToRevokedTokenAccessAttempts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuthenticationService.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("WaitingForTwoFactorAuthentication")
                        .HasColumnType("tinyint(1)");
