...
using Skuzzle.Core.Service.AuthenticationGateway.Extensions;
using Skuzzle.Core.Service.AuthenticationGateway.Models;
using Skuzzle.Core.Service.AuthenticationGateway.Services;
using Skuzzle.Core.Service.AuthenticationGateway.Storage;

namespace Skuzzle.Core.Service.AuthenticationGateway.Controllers;
...
public class AuthenticationController : ControllerBase
{
    ...
    //TODO: Put users to database rather than this single user /nb
