        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredMfaProvider = table.Column<int>(type: "integer", nullable: false),
                    ...
                    AddressLine3 = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RevokedTokenAccessAttempts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevokedFromIp = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2b3ad022-d787-4e96-9a59-55b286a6e482", "ab5a8990-8062-41ea-b0ce-395599973a36", "Default user role", "DefaultUser", "DEFAULTUSER" },
                    { "c6c93b9b-7e04-4812-8395-7b2eaad474da", "0971cc17-84a5-44fb-b773-1b7fd4e58c38", "Overall admin role", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_UserId_ConsumedAt",
                table: "RefreshTokens",
